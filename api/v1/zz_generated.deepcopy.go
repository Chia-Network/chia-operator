...
func (in *ChiaFarmerConfigSpec) DeepCopyInto(out *ChiaFarmerConfigSpec) {
	*out = *in
	in.CommonChiaConfigSpec.DeepCopyInto(&out.CommonChiaConfigSpec)
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *CommonChiaConfigSpec) DeepCopyInto(out *CommonChiaConfigSpec) {
	*out = *in
	if in.Testnet != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CommonChiaConfigSpec.
func (in *CommonChiaConfigSpec) DeepCopy() *CommonChiaConfigSpec {
	if in == nil {
		return nil
	}
	out := new(CommonChiaConfigSpec)
	in.DeepCopyInto(out)
	return out
}
