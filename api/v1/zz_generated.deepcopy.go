...
func (in *ChiaFarmerSpecChia) DeepCopyInto(out *ChiaFarmerSpecChia) {
	*out = *in
	...
	if in.FullNodePeers != nil {
		...
		*out = new([]FullNodePeer)
		if **in != nil {
			in, out := *in, *out
			*out = make([]FullNodePeer, len(*in))
			copy(*out, *in)
		}
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *FullNodePeer) DeepCopyInto(out *FullNodePeer) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new FullNodePeer.
func (in *FullNodePeer) DeepCopy() *FullNodePeer {
	if in == nil {
		return nil
	}
	out := new(FullNodePeer)
